        ...
        FastAutoGenerator.create(dataSourceProperties.getUrl(), dataSourceProperties.getUsername(), dataSourceProperties.getPassword())
                ...
                .globalConfig(builder -> {
                    builder.author("ZoneFun") // 设置作者
                            ...
                            .disableOpenDir()
                            .outputDir("D:\\Idea_workspace\\algorithm-web\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.zonefun") // 设置父包名
                            .moduleName("algorithm") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\Idea_workspace\\algorithm-web\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
